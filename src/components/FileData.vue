            ...
            <el-table
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <el-button type="success" v-if="scope.row.type==0" circle plain>重量</el-button>
                        <el-button type="danger" v-if="scope.row.type==1" circle plain>价值</el-button>
                    </template>
                </el-table-column>
                <el-table-column
                        prop="team"
...
<script>
  export default {
    ...
    methods:{
      // 获取数据
      getData(){
        this.$http.get("fileData/getAllData",{
          params:{
